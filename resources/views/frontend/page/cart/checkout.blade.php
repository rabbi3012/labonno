                ...
                @foreach(session()->get('myCart') as $key=>$cart)
                            <div class="form-group">
                                <div class="col-sm-3 col-xs-3">
                                    <img class="img-responsive" src="{{url('uploads/product',$cart['product_img'])}}" />
                                </div>
                                ...
                                <div class="col-sm-3 col-xs-3 text-right">
                                    <h6><span>$</span>{{(float)$cart['product_price'] * (int)$cart['quantity']}}</h6>
                                </div>
                            </div>
                            <div class="form-group">
                                <hr />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    @endphp
                                    <div class="pull-right"><span>$</span><span>{{$shipping}}</span></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-right"><span id="total_amount">${{$subtotal+$shipping}}</span>
